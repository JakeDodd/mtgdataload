...
// I named this cardfaces because it was modeled after card_faces, should probably be named CardFace if we are using for other purposes than cards with two faces
